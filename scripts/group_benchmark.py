...
DATA_DIR = project_root / "data" / "university"
TOP_K = 3
...
ALL_CHUNKERS = [
    ...
    RecursiveChunker(separators=markdown_separators, chunk_size=500),
...
def print_baseline() -> None:
    ...
    baseline_paths = [
        DATA_DIR / "dang-ky-hoc-phan.md",
        DATA_DIR / "chuyen-doi-tin-chi.md",
        DATA_DIR / "cap-bang-diem.md",
    ]
